...
// PathFuncExpression       = OnePathFuncNoArg | OnePathFuncArithmetic /*TODO*/
...
type FEOnePathFuncExpr struct {
	...
	//	OnePathFuncArithmetic *FEOnePathFuncArithmetic `@@`
}
...
func (f *FEMathArithmeticOp) OutputExpression() (Expression, error) {
	if f.Addition != nil {
		...
		return FuncExpr{FuncName: MathFuncMult}, nil
	} else if f.Division != nil {
