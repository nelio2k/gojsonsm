...
// Values by def should be enclosed within double quotes (or backtick if there are embedded quotes)
...
func (ctx *expressionParserContext) getCurrentToken() (string, ParseTokenType, error) {
	...
	} else if isFunc, _ := ctx.tokenIsBuiltInFuncType(token, true /*set internals*/); isFunc {
